# Анонимный телеграм‑бот для правозащитников
...
- `тз бот.docx` и `тз бот.pdf` — оригинальное техническое задание на русском языке, на основе которого реализован бот. Эти файлы включены для ознакомления и контроля соответствия.
